...
class PurchaseOrderRepository:
    ...
    def load_purchase_order_csv():
        ...
        try:
            return pd.read_csv(os.path.join(BASE_DIR, "data", "purchase-order-data-2012-2015-.csv"),
                               delimiter=",",
                               encoding="utf-8")
    ...
    def load_purchase_order_parquet():
        ...
        try:
            return pd.read_parquet(os.path.join(BASE_DIR, "data", "purchase-order-data-2012-2015-.parquet"))
        except Exception as e:
